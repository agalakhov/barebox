...
static struct s3c_sdhc_platform_data mini6410_esdhc0 = {
	...
	.pin_strength = 0, /* [2mA], 4mA, 7mA or 9mA */
	.pin_strength25 = 3, /* 2mA, 4mA, 7mA or [9mA] above 25 MHz */

/* don't ask me, how these delay settings are calculated. Just copy & paste ;) */
	.rx_delay_en = 1, /* use the delay setting for RX */
	.rx_delay = 3, /* basic delay + 2ns */
...
static int mini6410_devices_init(void)
{
	...
	s3c64xx_add_mci0(&mini6410_esdhc0);
