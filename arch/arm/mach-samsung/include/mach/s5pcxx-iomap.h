...
#define S3C_SDMMC_BASE		0xEB000000
...
#define S3C_SDMMC0_BASE (S3C_SDMMC_BASE + 0x000000)
#define S3C_SDMMC0_SIZE 0x100
#define S3C_SDMMC1_BASE (S3C_SDMMC_BASE + 0x100000)
#define S3C_SDMMC0_SIZE 0x100
#define S3C_SDMMC2_BASE (S3C_SDMMC_BASE + 0x200000)
#define S3C_SDMMC0_SIZE 0x100
#define S3C_SDMMC3_BASE (S3C_SDMMC_BASE + 0x300000)
#define S3C_SDMMC0_SIZE 0x100
